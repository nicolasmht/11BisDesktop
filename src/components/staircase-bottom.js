...
import Timeline from '../timelines/staircase-bottom';

function SaircaseBottom(scene) {

    // Create the parallax with objects
    let apartment = CreateApartment(Timeline[0], "Staircase-bottom");
    ...
    const currentApartment = scene.getObjectByName("Staircase-bottom");
